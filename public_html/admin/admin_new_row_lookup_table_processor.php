...
$new_db =  new db( );
    ...
    $title  = "Admin New Row Lookup Table Processor";
    $author = "Will Johnston";
    $keyWords = "Admin New Row Lookup Table Processor";
    $description = "Admin New Row Lookup Table Processor";
    $heading = "Admin New Row Lookup Table Processor";
    $showAds = 'n';
